 ...
 */
/** The design behind config-flash-exerciser, so its Quartus project is generated rather
...
object ConfigFlashExerciserDesign extends jop.config.BoardDesign {
  import jop.config._
...
/** Emit everything Quartus needs for config-flash-exerciser. */
object ConfigFlashExerciserBuild extends App {
  import jop.generate._
  val design   = ConfigFlashExerciserDesign
  val cfgName  = "configFlashExerciser"
  val revision = "config_flash_exerciser"
