// HwMath variant stubs — alias to base JumpTableData until HwMath microcode is generated
package jop

object HwMathJumpTableData extends JumpTableSource {
...
object SerialHwMathJumpTableData extends JumpTableSource {
