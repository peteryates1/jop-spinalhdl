...
| [QMTECH EP4CGX150](https://github.com/ChinaQMTECH/EP4CGX150DF27_CORE_BOARD) | Altera Cyclone IV GX | BRAM (on-chip) | Quartus Prime | Working at 100 MHz. JTAG bank is **2.5 V**; on the level-shifted [pico-usb-debug-jtag](https://github.com/peteryates1/pico-usb-debug-jtag) cable permanently since 2026-08-29 (`jop_sdram.sof` in 72 s at 6 MHz, then boots and runs). A genuine USB-Blaster also works |
