...
| [QMTECH EP4CGX150](https://github.com/ChinaQMTECH/EP4CGX150DF27_CORE_BOARD) | Altera Cyclone IV GX | BRAM (on-chip) | Quartus Prime | Working at 100 MHz. JTAG bank is **2.5 V**; programs from a genuine USB-Blaster or from the level-shifted [pico-usb-debug-jtag](https://github.com/peteryates1/pico-usb-debug-jtag) cable (4.88 MB .sof in 43 s at 6 MHz) |
