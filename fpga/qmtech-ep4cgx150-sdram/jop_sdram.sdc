...
# QMTECH EP4CGX150, 50 MHz input clock, PLL to 80 MHz (dram_pll.vhd clk1/clk2
# = 8/5). A 4-CORE SMP build does not close at 80 — the BMB arbiter misses by
# -2.399 ns — and needs the PLL set to 6/5 (60 MHz) plus a matching clkMhz on
# JopConfig.ep4cgx150Smp. Nothing cross-checks the two; a mismatch gives a
# wrong-speed console and a microsecond counter that lies, not a build error.
