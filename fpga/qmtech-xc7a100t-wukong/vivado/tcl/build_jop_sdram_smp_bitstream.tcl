...
set build_dir  [file normalize [file join $repo_root vivado/build/wukong_jop_sdram_smp]]
...
# Read RTL
read_verilog [file join $rtl_dir JopSmpSdramWukongTop.v]

# Copy $readmemb data files to build dir (Vivado resolves relative to working dir)
foreach f [glob -nocomplain [file join $rtl_dir JopSmpSdramWukongTop.v_*.bin]] {
...
# Synthesize
synth_design -top JopSmpSdramWukongTop -part xc7a100tfgg676-2
...
# Write bitstream
write_bitstream -force [file join $build_dir JopSmpSdramWukongTop.bit]

source [file join $script_dir ../../../scripts/vivado_fit_summary.tcl]
puts "INFO: Bitstream at [file join $build_dir JopSmpSdramWukongTop.bit]"
emit_fit_summary $build_dir [file join $rtl_dir JopSmpSdramWukongTop.summary.txt]
