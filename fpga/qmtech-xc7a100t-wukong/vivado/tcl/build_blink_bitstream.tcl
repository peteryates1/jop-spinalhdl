# Bitstream build script for Wukong XC7A100T LED blinker.
# Requires an existing project created via create_blink_project.tcl.
...
puts "INFO: Bitstream available at ${impl_dir}/WukongBlink.bit"
