# Bitstream build script for JOP BRAM on Wukong XC7A100T.
# Requires an existing project created via create_project.tcl.
...
puts "INFO: Bitstream available at ${impl_dir}/JopBramWukongTop.bit"
