# QMTECH XC7A100T Wukong V3 — JOP SDRAM constraints
# Based on wukong_sdram.xdc with ser_rxd and resetn added, j10_led removed.

# 50 MHz system clock (Y1 oscillator) — default CD clock pin is "clk"
