# Program the first detected hardware target with the JOP DDR3 SMP bitstream.
# Run via: vivado -mode batch -source vivado/tcl/program_bitstream_smp.tcl

set script_dir [file dirname [file normalize [info script]]]
set repo_root  [file normalize [file join $script_dir ../..]]
set bit_file   [file join $repo_root vivado/build/jop_ddr3_smp/jop_ddr3_smp.runs/impl_1/JopDdr3SmpTop.bit]
...
puts "INFO: Programming complete (SMP)"
close_hw_manager
