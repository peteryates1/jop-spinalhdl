# Vivado project creation script for DDR3 GC Exerciser on Alchitry AU V2.
# Run with: vivado -mode batch -source vivado/tcl/create_project_exerciser.tcl
...
set rtl_file [file join $rtl_dir Ddr3GcExerciserTop.v]
if {[file exists $rtl_file]} {
  add_files -norecurse $rtl_file
}

# Add generated .bin files (BRAM init)
set bin_files [glob -nocomplain [file join $rtl_dir Ddr3GcExerciserTop*.bin]]
...
# Set top module
if {[llength [get_files -quiet [file join $rtl_dir Ddr3GcExerciserTop.v]]] > 0} {
  set_property top Ddr3GcExerciserTop [current_fileset]
}
