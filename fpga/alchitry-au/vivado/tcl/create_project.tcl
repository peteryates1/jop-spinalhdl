# Vivado project creation script for JOP DDR3 on Alchitry AU V2.
...
set proj_name  "jop_ddr3"

file mkdir $build_dir
create_project -force $proj_name [file join $build_dir $proj_name] -part xc7a35tftg256-2

# Add generated RTL (only JopDdr3Top.v to avoid duplicate module defs from other top-levels)
...
# Add generated .bin files (BRAM init) — only JopDdr3Top files
