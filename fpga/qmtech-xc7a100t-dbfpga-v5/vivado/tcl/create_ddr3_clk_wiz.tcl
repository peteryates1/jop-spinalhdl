# Clock wizard for JOP DDR3 on QMTECH XC7A100T Core Board + DB_FPGA V5.
# 50 MHz in -> 100 MHz (MIG sys_clk) + 200 MHz (MIG ref_clk) + 125 MHz (ETH GMII).
# The 125 MHz output is pruned by Vivado if unused (non-GMII builds).
