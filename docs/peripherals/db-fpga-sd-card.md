...
| `build/<config>/quartus/` | SD Native Quartus project, generated by `SdNativeExerciserBuild` |
| `build/<config>/quartus/` | SD SPI Quartus project, generated by `SdSpiExerciserBuild` |
