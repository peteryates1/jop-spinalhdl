...
- [Phase 5: Hardware Description — System / Board / FPGA / Memory / Devices](#phase-5-hardware-description--system--board--fpga--memory--devices)
  ...
  - [Boards — unified type with pin mappings](#boards--unified-type-with-pin-mappings)
  - [Device-to-component mapping — SpinalHDL variant selection](#device-to-component-mapping--spinalhdl-variant-selection)
  ...
  - [JOP System layer — processor system organization](#jop-system-layer--processor-system-organization)
    - [Memory map and I/O space](#memory-map-and-io-space)
    ...
    - [Top-level system configuration](#top-level-system-configuration)
    - [Address allocation](#address-allocation)
    - [Generated constants (Const.java)](#generated-constants-constjava)
  - [System presets — builder pattern with `copy()`](#system-presets--builder-pattern-with-copy)
  - [Migration from current IoConfig](#migration-from-current-ioconfig)
  - [What the config drives](#what-the-config-drives)
...
- [Phase 6: Board-Specific Modular Java Runtime](#phase-6-board-specific-modular-java-runtime)
  ...
  - [1. Const.java generation](#1-constjava-generation)
  - [2. JVM.java bytecode handlers](#2-jvmjava-bytecode-handlers)
  - [3. Device driver inclusion](#3-device-driver-inclusion)
  - [4. Build integration](#4-build-integration)
...
- [Phase 8: Build System](#phase-8-build-system)
  ...
  - [FPGA hardware test (step 7)](#fpga-hardware-test-step-7)
