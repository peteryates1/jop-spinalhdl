/*
 * Adapted from OpenJDK 6 for JOP. Replaced System.arraycopy with manual
 * loops, removed clone(). No Locale dependencies.
...
final class DigitList {
    ...
    public void append(char digit) {
        if (count == digits.length) {
            char[] newDigits = new char[count + 100];
            for (int i = 0; i < count; i++) {
