...
//         Object[] a = list.toArray();
    ...
    // Wrapper classes (Unmodifiable*, Synchronized*, Checked*, etc.) removed —
    // they don't compile under JOP's Collection interface which declares toArray().
    // EMPTY_LIST/SET/MAP also removed (depend on wrapper classes).
