...
public class JOPConfig {
    ...
    public static final StringOption ASM_FILE =
            new StringOption("jop-asm-file", "JOP assembler file", "asm" + File.separator + "generated" + File.separator + "jvmgen.asm");

    public static final IntegerOption READ_WAIT_STATES =
            new IntegerOption("jop-rws", "JOP read wait states", 1);
    public static final IntegerOption WRITE_WAIT_STATES =
            new IntegerOption("jop-wws", "JOP write wait states", 2);
    ...
    public static final IntegerOption CMP_CPUS =
            new IntegerOption("jop-cmp-cpus", "JOP number of processors", 8);
    public static final IntegerOption CMP_TIMESLOT =
            new IntegerOption("jop-cmp-timeslot", "JOP arbiter timeslot cycles", 10);
    ...
    public static final IntegerOption OBJECT_CACHE_LOAD_FIELD_CYCLES =
            new IntegerOption("jop-ocache-load-field-cycles", "JOP object cache load cycles for field (bypass)", 8);
    public static final IntegerOption OBJECT_CACHE_LOAD_BLOCK_CYCLES =
            new IntegerOption("jop-ocache-load-block-cycles", "JOP object cache load cycles for cache block (miss)", 8);
